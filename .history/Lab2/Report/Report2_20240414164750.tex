...
\section{Zadanie 3}
    ...
    \subsection{Teoria}
    \textbf{Plik PNG} (Portable Network Graphics) to format obrazów rastrowych, który charakteryzuje się 
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Sygnatura tego formatu to: 89 50 4E 47 0D 0A 1A 0A (hex).
        \end{itemize}
    \end{itemize}
