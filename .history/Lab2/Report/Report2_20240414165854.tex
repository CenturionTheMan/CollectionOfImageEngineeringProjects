...
\section{Zadanie 3}
    ...
    Format plików PNG (Portable Network Graphics) jest zaawansowanym formatem obrazów rastrowych. Charakteryzuje się on zachowaniem przezroczystości oraz kompresją bezstratną.

    \subsubsection*{Nagłówek PNG}

    Początek każdego pliku PNG jest określony przez 8-bajtowy nagłówek. Specyficzna sekwencja znaków, znana jako sygnatura, \textbackslash 211 P N G \textbackslash r \textbackslash n \textbackslash 032 \textbackslash n, identyfikuje plik jako format PNG.
