...
\section{Zadanie pierwsze}
    ...
    \begin{figure}[H]
        \centering
        \resizebox{\columnwidth}{!}{%
        \includegraphics{Img/zad1_fil1.png}%
        }
        \caption{Wizualizacja maski filtru górnoprzepustowego podanego w zadaniu}
    \end{figure}

    \begin{figure}[H]
        \centering
        \resizebox{\columnwidth}{!}{%
        \includegraphics{Img/zad1_fil2.png}%
        }
        \caption{Wizualizacja maski filtru piramidalnego}
    \end{figure}

    \begin{figure}[H]
        \centering
        \resizebox{\columnwidth}{!}{%
        \includegraphics{Img/zad1_fil3.png}%
        }
        \caption{Wizualizacja maski filtru kołowego}
    \end{figure}
...
\section{Zadanie trzecie}
    ...
    \sub{Prezentacja wykonanego zadania}
    \begin{figure}[H]
        \centering
        \resizebox{\columnwidth}{!}{%
