...
\section{Zadanie trzecie}
    ...
    Konwersję wiliśmy wykonać za pomocą wzoru:
    \[
        \begin{bmatrix}
            Y \\
            Cr \\
    ...
    \subsection{Teoria}
    Model YCbCr jest modelem przestrzeni barw, który składa się z trzech składowych: Y, Cb, Cr.
    Składowa Y odpowiada za jasność obrazu, a składowe Cb i Cr za kolor. 
    Model ten jest wykorzystywany w przemyśle filmowym, telewizyjnym i fotografii cyfrowej.
